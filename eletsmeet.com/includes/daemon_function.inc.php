...
function getOverdueScheduleList($overdue_date, $dataHelper)
{
    try
    {
        ...
        $strSqlStatement = "SELECT schedule_id, meeting_instance, schedule_status FROM schedule_details WHERE schedule_status = '0' AND meeting_timestamp_gmt <= '".trim($overdue_date)."';";

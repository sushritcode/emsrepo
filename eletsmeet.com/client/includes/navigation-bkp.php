...
<div class="navbar  animated fadeIn">
    <div class="navbar-inner">
        <div class="container">
            ...
            <a class="brand" href="<?php echo $HOME_URL; ?>"><img src="<?php echo CLIENT_IMG_PATH; ?>letsmeet.png" vspace="10px" height="105" width="188" alt="Quadridge Technologies" title="Quadridge Technologies"></a>

...
try
{
    ...
    try
    {
        ...
        $txtContactId  = trim($arrContactDetails[0]['personal_contact_id']);
        ...
        else
        {
            ...
            if (sizeof($errors) == 0)
            {
                try
                {
                    ...
                    $updContactDetails = updContactDetails($strContactId, $strNickName, $strFirstName, $strLastName, $strEmail, $strIddCode, $strMobile, $strGroupName, PERSONAL_CONTACT_TYPE, $strCK_user_id, $objDataHelper);

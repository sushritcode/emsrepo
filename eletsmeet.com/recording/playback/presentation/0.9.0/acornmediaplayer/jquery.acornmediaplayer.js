			...
			var goSwap = function() {
				if (swapped === false) {
					...
					//$('#videoRecordingWrapper').width("800px");
                                                                                          $('#videoRecordingWrapper').width("700px");
					...
					//$('#videoRecordingWrapper').width("400px");
                                                                                          $('#videoRecordingWrapper').width("350px");

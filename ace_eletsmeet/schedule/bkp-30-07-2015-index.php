                            ...
                            <div class="col-xs-12">
                                ...
                                <?php if ($stat == "TRUE"){ ?>
                                    ...
                                    <div role="form" class="form-horizontal">
                                                                ...
                                                                <div class="form-group" id="schdatetime" style="display: none;">
                                                                    <div class="col-sm-4 no-padding-right">
                                                                        ...
                                                                        <div class="input-group col-sm-7">
                                                                            <input type="text" name="datetime" data-date-format="dd-mm-yyyy" id="id-date-picker-1" class="form-control date-picker" readonly="true" contenteditable="false">
                                                                    ...
                                                                    <div class="col-sm-4 no-padding-right">
                                                                        ...
                                                                        <div class="input-group col-sm-7">
                                                                            <input id="timepicker1" type="text" class="form-control" readonly="true" contenteditable="false"/>
                                                                            <span class="input-group-addon">
                                                                    ...
                                                                    <div class="widget-box widget-color-blue ui-sortable-handle">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            ...
                                                                                            <div>
                                                                                                    <input type="text" name="aSearch" id="aSearch" onkeyup="javascript:autoSuggest(this);" class="form-control col-xs-12" placeholder="Type here to Search Contact List.">
                                                                                            </div>
                                        ...
                                        <!--                                    <div class="row">
                                                                                <div class="widget-box">
                                                                                    <div class="widget-header"><h4 class="widget-title">3. Select Invitees</h4></div>
                                                                                    <div class="widget-body">
                                                                                        <div class="widget-main">
                                                                                            ...
                                                                                            <div class="row">
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                        <div class="widget-box">
                                                                                                                <div class="widget-header widget-header-small">
                                                                                                                        <h5 class="widget-title lighter">Contact List</h5>
                                                                                                                </div>
                                                                                                                ...
                                                                                                                <div class="widget-body">
                                                                                                                        <div class="widget-main no-padding">
                                                                                                                            ...
                                                                                                                            <div class="form-group">
                                                                                                                                <label for="form-field-1-1" class="col-sm-2 control-label no-padding-right"> Meeting Agenda </label>
                                                                                                                                <div class="col-sm-9">
                                                                                                                                    <textarea placeholder="Type your Meeting Agenda" id="form-field-8" class="form-control"></textarea>
                                                                                                                                </div>
                                                                                                                            </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                        <div class="widget-box">
                                                                                                                <div class="widget-header widget-header-small">
                                                                                                                        <h5 class="widget-title lighter">Add Other Invitee</h5>
                                                                                                                </div>
                                                                                                ...
                                                                                                <div class="col-sm-4">
                                                                                                        <div class="widget-box">
                                                                                                                <div class="widget-header widget-header-small">
                                                                                                                        <h5 class="widget-title lighter">Invitee List</h5>
                                                                                                                </div>
                                                                                ...
                                                                                <div class="widget-box">
                                                                                    ...
                                                                                    <div class="widget-body">
                                                                                        <div class="widget-main">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                    <div class="col-sm-9">
                                                                                                             <select id="form-field-select-1" class="col-sm-5" multiple="multiple">
                                                                                                                <option value=""></option>
                                        ...
                                        <!--                                    <div class="row">
                                                                                <div class="well">
                                                                                    <div class="infobox-green width-35">
                                                                                        <label><h1>Total Invitee : 0 </h1></label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>-->
                    ...
                    $.ajax ({
                        ...
                        success: function(html) {
                            if(html.length > 0) {
                                ...
                                $("#contactList").html("<div class='alert alert-block alert-warning'><strong >Sorry</strong>, No Contact List Available.</div>");
                            }
                        }
                    });
                } 

...
$CLIENT_CONST_PAGEID = 'My Contacts';
...
$contacts = getAllcontactsByUserID($strSetClient_ID , $objDataHelper);

$arrGroups = getAllgroups($strSetClient_ID , $objDataHelper);
	   ...
	   <div id="dynamic-table_wrapper" class="dataTables_wrapper form-inline no-footer">
		 ...
		 <?php 
		    ...
		    <tr role="row" class="<?php echo $trclass;?>">
		       ...
		       <td><?php 
                                                         if (strlen($contacts[$i]['contact_mobile_number']) <= 0) 
                                                        {

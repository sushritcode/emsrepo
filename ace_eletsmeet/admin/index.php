            ...
            <div class="row">
                <div class="span12 hidden-phone" style="position:relative">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        <div class="carousel-inner" style="height: 350px; margin: 75px 0 0 -15px;">
                            <div class="item active">
                                <img src="<?php echo ADM_IMG_PATH; ?>letsmeet-logo.png" alt="LetsMeet">
                            </div>
                    ...
                    <div class="hubble_login" id="popup" style="display:none">
                        <div class="s16 b mB10">Forgot Password <img class="fR" id="close" border='0' title='Close' alt='Close' src='<?php echo ADM_IMG_PATH; ?>close_black.png'></div></br>

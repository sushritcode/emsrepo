        ...
        <div class="container">
            <div class="row">
                <div class="span12" style="margin-top: 0px;">
                    <div class="fL">
                            <img class="brand" src="<?php echo ADM_IMG_PATH ; ?>eletsmeet_com.png" vspace="0px" height="75" width="125" alt="<?php echo CUSTOM_LOGO_TITLE; ?>" title="<?php echo CUSTOM_LOGO_TITLE; ?>"> 
                    </div>
                    <div class="fR">

...
<!--                             <div class="s22 b mB20"><span class="color_0088CC">Total Licenses</span>&nbsp;:&nbsp;<?php echo $totalLicense;?></div>-->
                                    ...
                                    <table class="tblz01" width="100%" id="client-results">
                                        ...
                                        <?php
                                            ...
                                            $arrClientStatus[0]= "Pending";
                                            $arrClientStatus[1]= "Active";
                                            $arrClientStatus[2]= "Deactive";
                                            $arrClientStatus[3]= "Deleted";
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>&nbsp;<?php echo $arrPlanInformation[$intCntr1]['subscription_start_date_gmt']; ?></td>
                                                                      <?php 
                                                                        ...
                                                                        if ($curDate > $expDate) 
                                                                       {
                                                                             echo "<td style='color: #f00;'>&nbsp;".$arrPlanInformation[$intCntr1]['subscription_end_date_gmt']."</td>";
                                                                        }
                                                                        else
                                                                        {
                                                                            if ($expDays <= 15) 
                                                                            {
                                                                                echo "<td style='color: #E97B00;'>&nbsp;".$arrPlanInformation[$intCntr1]['subscription_end_date_gmt']."</td>";
                                                                            }
                                                                            else
                                                                            {
                                                                                echo "<td style='color: green;'>&nbsp;".$arrPlanInformation[$intCntr1]['subscription_end_date_gmt']."</td>";
                                                                            }
                                                                        }
                                                                       ?>
                                                                </tr>
